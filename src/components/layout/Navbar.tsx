        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-md bg-cyan-950 px-2 py-0.5 text-[10px] font-semibold text-cyan-400 border border-cyan-800/50">
                AgentOS
              </span>
            </div>
            <p className="text-[11px] text-slate-400">OpenSource AgentOS Control Plane</p>
          </div>
        </div>

        {/* Center Mode Switcher Tabs */}
        <nav className="flex items-center rounded-lg bg-slate-900/90 p-1 border border-slate-800">
          <button
